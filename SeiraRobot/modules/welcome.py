...
import SeiraRobot.modules.sql.welcome_sql as sql
...
from SeiraRobot.modules.helper_funcs.msg_types import get_welcome_type
        ...
        if should_welc:
            ...
            if new_mem.id == OWNER_ID:
                ...
                welcome_log = (
                    ...
                    f"#USER_JOINED\n"
                    f"My Master @xyzsethhh just joined the chat"
                )
                continue
