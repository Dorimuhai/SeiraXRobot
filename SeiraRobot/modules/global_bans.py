...
import SeiraRobot.modules.sql.global_bans_sql as sql
from SeiraRobot.modules.sql.users_sql import get_user_com_chats
...
from SeiraRobot.modules.helper_funcs.misc import send_to_list
...
def gban(update: Update, context: CallbackContext):
    ...
    if gban_time > 60:
        ...
        message.reply_text("Jamet Berhasil Di Banned Bosque!.", parse_mode=ParseMode.HTML)
    else:
        message.reply_text("Jamet Berhasil Di Banned Bosque!.", parse_mode=ParseMode.HTML)
