...
import SeiraRobot.modules.sql.global_bans_sql as gban_sql
import SeiraRobot.modules.sql.users_sql as user_sql
from SeiraRobot import DEV_USERS, OWNER_ID, dispatcher
